...
def novo_valor(request):
    if request.method == 'GET':
        ...
        # TODO: Mnsagem processada de a cordo com o tipo
...
def view_extrato(request):
    ...
    #TODO: Botão zerar os filtros==>FEITO
...
def exportar_pdf(request):
    ...
    path_output.seek(0)
    #OBS:o extrato não carrega os dados do filtro quando é exportado, sempre só mostra os dados iniciais
