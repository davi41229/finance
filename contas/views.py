...
def ver_contas(request):
    ...
    # TODO: Fazer a logica do pagamento das contas
    #TODO: Mostras as quantidades das contas na tela no lado direit como um relatorio, numero de contas: vencidas,proximas do venc e restantes.
