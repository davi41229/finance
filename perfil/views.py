...
# conteudo da viewprincipal  igual a view home, só para renderizar na url '/'
def principal(request):
    ...
    return render(request, 'home.html',
                  {'contas': contas, 'total_contas': total_contas, 'total_entradas': total_entradas,
